...
-- 2. Usuario (contraseñas con hash PBKDF2-SHA256; ver Base_de_Datos/README.txt)
-- Administrador: juan@correo.com / clave123
-- Usuario: ana@correo.com / clave456
-- Administrador: admin@skilledguard.com / admin123
-- Usuario: usuario@skilledguard.com / user123
...
VALUES
('dddddddd-dddd-dddd-dddd-dddddddddddd', 'Juan', 'Pérez', '33333333-3333-3333-3333-333333333333', '12345678', 'admin', 'juan@correo.com', 'Calle 1', 'I+OLp1mN4ZoUkOoNDDbtGTs5Et2QlmrQWTn1B7B18/CS6LmgLuvb00X1qo/tUsW+', GETDATE(), NULL, '11111111-1111-1111-1111-111111111111'),
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Ana', 'Gómez', '44444444-4444-4444-4444-444444444444', '87654321', 'user', 'ana@correo.com', 'Calle 2', 'FJEDl0noHQ7eEgat67qIqqxC9p3M0jihMr9ORNwkreCHWcWjiM3oqtvmjMy9ir6r', GETDATE(), NULL, '22222222-2222-2222-2222-222222222222'),
('18181818-1818-1818-1818-181818181818', 'Admin', 'Sistema', '33333333-3333-3333-3333-333333333333', '11223344', 'admin', 'admin@skilledguard.com', 'Sede Central', '3lA7QNJH8OFOdh+vlCQr9RrW2TIDSgBtqFpP2U966auYtdETTUt1bFab89knd2MB', GETDATE(), NULL, '11111111-1111-1111-1111-111111111111'),
('19191919-1919-1919-1919-191919191919', 'Usuario', 'Prueba', '33333333-3333-3333-3333-333333333333', '55667788', 'user', 'usuario@skilledguard.com', 'Sede Norte', 'e9rRXkjbbr6q63UDGUPcJqRdZkv450ITjwpTohjdq7fNn32GQJiw+nJX9kgTm49o', GETDATE(), NULL, '22222222-2222-2222-2222-222222222222');
...
('20202020-2020-2020-2020-202020202020', '18181818-1818-1818-1818-181818181818', 'Primer log de Admin', GETDATE()),
('21212121-2121-2121-2121-212121212121', '19191919-1919-1919-1919-191919191919', 'Primer log de Usuario Prueba', GETDATE());
